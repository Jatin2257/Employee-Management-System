...
public class RemoveEmployee extends JFrame implements ActionListener {
    ...
    RemoveEmployee() {
        ...
        try {
            Conn c = new Conn();
            String query = "select * from employee.employee where emId = '"+cEmpId.getSelectedItem()+"'";
            ResultSet rs = c.s.executeQuery(query);
            while(rs.next()) {
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == delete) {
            try {
                Conn c = new Conn();
                String query = "delete from employee.employee where emId = '"+cEmpId.getSelectedItem()+"'";
